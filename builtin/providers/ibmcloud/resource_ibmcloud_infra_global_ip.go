...
func resourceIBMCloudInfraGlobalIp() *schema.Resource {
	return &schema.Resource{
		Create:   resourceIBMCloudInfraGlobalIpCreate,
		Read:     resourceIBMCloudInfraGlobalIpRead,
		Update:   resourceIBMCloudInfraGlobalIpUpdate,
		Delete:   resourceIBMCloudInfraGlobalIpDelete,
		Exists:   resourceIBMCloudInfraGlobalIpExists,
...
func resourceIBMCloudInfraGlobalIpCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceIBMCloudInfraGlobalIpUpdate(d, meta)
}

func resourceIBMCloudInfraGlobalIpRead(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ClientSession).SoftLayerSession()
...
func resourceIBMCloudInfraGlobalIpUpdate(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ClientSession).SoftLayerSession()
	service := services.GetNetworkSubnetIpAddressGlobalService(sess)
...
func resourceIBMCloudInfraGlobalIpDelete(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ClientSession).SoftLayerSession()
	service := services.GetNetworkSubnetIpAddressGlobalService(sess)
...
func resourceIBMCloudInfraGlobalIpExists(d *schema.ResourceData, meta interface{}) (bool, error) {
	sess := meta.(ClientSession).SoftLayerSession()
	service := services.GetNetworkSubnetIpAddressGlobalService(sess)
