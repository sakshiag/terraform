...
func resourceIBMCloudInfraLbVpxHa() *schema.Resource {
	return &schema.Resource{
		Create:   resourceIBMCloudInfraLbVpxHaCreate,
		Read:     resourceIBMCloudInfraLbVpxHaRead,
		Update:   resourceIBMCloudInfraLbVpxHaUpdate,
		Delete:   resourceIBMCloudInfraLbVpxHaDelete,
		Exists:   resourceIBMCloudInfraLbVpxHaExists,
...
func resourceIBMCloudInfraLbVpxHaCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceIBMCloudInfraLbVpxHaRead(d, meta)
}

func resourceIBMCloudInfraLbVpxHaRead(d *schema.ResourceData, meta interface{}) error {
...
func resourceIBMCloudInfraLbVpxHaUpdate(d *schema.ResourceData, meta interface{}) error {
	primaryId, secondaryId, err := parseHAId(d.Id())
	if err != nil {
...
func resourceIBMCloudInfraLbVpxHaDelete(d *schema.ResourceData, meta interface{}) error {
	primaryId, secondaryId, err := parseHAId(d.Id())
	if err != nil {
		return fmt.Errorf("Error deleting HA %s", err.Error())
	}
...
func resourceIBMCloudInfraLbVpxHaExists(d *schema.ResourceData, meta interface{}) (bool, error) {
