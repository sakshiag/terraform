...
func resourceIBMCloudInfraBlockStorage() *schema.Resource {
	return &schema.Resource{
		Create:   resourceIBMCloudInfraBlockStorageCreate,
		Read:     resourceIBMCloudInfraBlockStorageRead,
		Update:   resourceIBMCloudInfraBlockStorageUpdate,
		Delete:   resourceIBMCloudInfraBlockStorageDelete,
		Exists:   resourceIBMCloudInfraBlockStorageExists,
...
func resourceIBMCloudInfraBlockStorageCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceIBMCloudInfraBlockStorageUpdate(d, meta)
}

func resourceIBMCloudInfraBlockStorageRead(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ClientSession).SoftLayerSession()
...
func resourceIBMCloudInfraBlockStorageUpdate(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ClientSession).SoftLayerSession()
	...
	return resourceIBMCloudInfraBlockStorageRead(d, meta)
}

func resourceIBMCloudInfraBlockStorageDelete(d *schema.ResourceData, meta interface{}) error {
	return resourceIBMCloudInfraFileStorageDelete(d, meta)
}

func resourceIBMCloudInfraBlockStorageExists(d *schema.ResourceData, meta interface{}) (bool, error) {
	return resourceIBMCloudInfraFileStorageExists(d, meta)
}
