...
func resourceIBMCloudInfraFileStorage() *schema.Resource {
	return &schema.Resource{
		Create:   resourceIBMCloudInfraFileStorageCreate,
		Read:     resourceIBMCloudInfraFileStorageRead,
		Update:   resourceIBMCloudInfraFileStorageUpdate,
		Delete:   resourceIBMCloudInfraFileStorageDelete,
		Exists:   resourceIBMCloudInfraFileStorageExists,
...
func resourceIBMCloudInfraFileStorageCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceIBMCloudInfraFileStorageUpdate(d, meta)
}

func resourceIBMCloudInfraFileStorageRead(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ClientSession).SoftLayerSession()
...
func resourceIBMCloudInfraFileStorageUpdate(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ClientSession).SoftLayerSession()
	...
	return resourceIBMCloudInfraFileStorageRead(d, meta)
}

func resourceIBMCloudInfraFileStorageDelete(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ClientSession).SoftLayerSession()
...
func resourceIBMCloudInfraFileStorageExists(d *schema.ResourceData, meta interface{}) (bool, error) {
	sess := meta.(ClientSession).SoftLayerSession()
