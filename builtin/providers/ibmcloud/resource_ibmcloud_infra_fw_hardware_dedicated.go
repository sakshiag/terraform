...
func resourceIBMCloudInfraFwHardwareDedicated() *schema.Resource {
	return &schema.Resource{
		Create:   resourceIBMCloudInfraFwHardwareDedicatedCreate,
		Read:     resourceIBMCloudInfraFwHardwareDedicatedRead,
		Delete:   resourceIBMCloudInfraFwHardwareDedicatedDelete,
		Exists:   resourceIBMCloudInfraFwHardwareDedicatedExists,
...
func resourceIBMCloudInfraFwHardwareDedicatedCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceIBMCloudInfraFwHardwareDedicatedRead(d, meta)
}

func resourceIBMCloudInfraFwHardwareDedicatedRead(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ClientSession).SoftLayerSession()
...
func resourceIBMCloudInfraFwHardwareDedicatedDelete(d *schema.ResourceData, meta interface{}) error {
	sess := meta.(ClientSession).SoftLayerSession()
...
func resourceIBMCloudInfraFwHardwareDedicatedExists(d *schema.ResourceData, meta interface{}) (bool, error) {
	sess := meta.(ClientSession).SoftLayerSession()
