...
func TestAccIBMCloudInfraSecurityCertififate_Basic(t *testing.T) {
	resource.Test(t, resource.TestCase{
		PreCheck:  func() { testAccPreCheck(t) },
		Providers: testAccProviders,
		Steps: []resource.TestStep{
			resource.TestStep{
				Config: testAccCheckIBMCloudInfraSecurityCertificateConfig_basic,
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(
						"ibmcloud_infra_security_certificate.test-cert", "key_size", "2048"),
					resource.TestCheckResourceAttr(
						"ibmcloud_infra_security_certificate.test-cert", "common_name", "*.weather.com"),
				),
			},
		},
	})
...
var testAccCheckIBMCloudInfraSecurityCertificateConfig_basic = `
resource "ibmcloud_infra_security_certificate" "test-cert" {
    certificate = <<EOF
-----BEGIN CERTIFICATE-----
