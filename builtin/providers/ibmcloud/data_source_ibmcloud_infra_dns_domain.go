...
func dataSourceIBMCloudInfraDNSDomain() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceIBMCloudInfraDNSDomainRead,
...
func dataSourceIBMCloudInfraDNSDomainRead(d *schema.ResourceData, meta interface{}) error {
