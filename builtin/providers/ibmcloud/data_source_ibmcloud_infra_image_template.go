...
func dataSourceIBMCloudInfraImageTemplate() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceIBMCloudInfraImageTemplateRead,
...
func dataSourceIBMCloudInfraImageTemplateRead(d *schema.ResourceData, meta interface{}) error {
