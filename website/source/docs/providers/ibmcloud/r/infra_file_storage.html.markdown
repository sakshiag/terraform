---
layout: "ibmcloud"
page_title: "IBM Cloud: file_storage"
sidebar_current: "docs-ibmcloud-resource-infra-file-storage"
description: |-
  Manages IBM Cloud Infrastructure file storage.
---

# ibmcloud\_infra_file_storage
